...
<details>
  ...
  ### Get all playlists
  `curl -i https://mario.fma.lab.myobdev.com/playlists`
...
<details>
  ...
  ``curl -i -X POST https://mario.fma.lab.myobdev.com/playlists/{id}``
...
<details>
  ...
  ``curl -i -X PUT https://mario.fma.lab.myobdev.com/playlists``
...
<details>
  ...
  ``curl -i -X DELETE https://mario.fma.lab.myobdev.com/playlists/{id}``
...
<details>
  ...
  ### Get songs to browse or get songs by name
    ``curl -i https://mario.fma.lab.myobdev.com/songs}``
...
<details>
  ...
  ### Get random song by genre
    ``curl -i https://mario.fma.lab.myobdev.com/songs/{genre}``
...
<details>
  ...
  ### healthcheck
    ``curl -i https://mario.fma.lab.myobdev.com/healthcheck``
